namespace v1336.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CommentTheme_Id = c.Int(),
                        OrderRow_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CommentThemes", t => t.CommentTheme_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OrderRows", "CommentId", "dbo.Comments");
            DropForeignKey("dbo.Comments", "UserId", "dbo.Users");
            DropForeignKey("dbo.RoleUsers", "User_Id", "dbo.Users");
            DropForeignKey("dbo.RoleUsers", "Role_Id", "dbo.Roles");
            DropForeignKey("dbo.Employees", "Id", "dbo.Users");
            DropForeignKey("dbo.Employees", "OrderRow_Id", "dbo.OrderRows");
            DropForeignKey("dbo.Employees", "DepartmentId", "dbo.Departments");
            DropForeignKey("dbo.Employees", "CommentTheme_Id", "dbo.CommentThemes");
            ...
            DropIndex("dbo.Employees", new[] { "OrderRow_Id" });
            DropIndex("dbo.Employees", new[] { "CommentTheme_Id" });
            ...
            DropIndex("dbo.OrderRows", new[] { "CommentId" });
